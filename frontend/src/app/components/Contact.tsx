        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 grid-rows-auto sm:grid-rows-3 h-full">
          ...
          >
            <motion.div
              ...
              animate={{
                opacity: isBlogHovered ? 1 : 0,
                x: isBlogHovered ? 0 : 5,
                visibility: isBlogHovered
                  ? ("visible" as const)
                  : ("hidden" as const),
              }}
          ...
          >
            <motion.div
              ...
              animate={{
                ...
                x: isGithubHovered ? 0 : 5,
                visibility: isGithubHovered
                  ? ("visible" as const)
                  : ("hidden" as const),
              }}
              transition={{ duration: 0.2 }}
          ...
          >
            <motion.div
              ...
              animate={{
                ...
                x: isLinkedInHovered ? 0 : 5,
                visibility: isLinkedInHovered
                  ? ("visible" as const)
                  : ("hidden" as const),
              }}
              transition={{ duration: 0.2 }}
